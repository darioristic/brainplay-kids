...
import { ArrowRight, Star, Shield, Brain, Sparkles, Play, Users, CheckCircle2, ChevronDown } from 'lucide-react';
...
export const LandingPage: React.FC<LandingPageProps> = ({ onLogin, onCreate, onParentLogin }) => {
  ...
  const HeroOwl = () => (
    <svg viewBox="0 0 200 200" className="w-full h-full drop-shadow-xl animate-float">
      {/* Body */}
      <circle cx="100" cy="110" r="80" fill="#F4C95D" /> {/* Honey */}
      <path d="M 60 40 Q 100 20 140 40" fill="#F4C95D" /> {/* Ears */}
      
      {/* Face Plate */}
      <ellipse cx="70" cy="90" rx="35" ry="30" fill="#FDFBF7" /> {/* Cream */}
